...
function loadDataTable() {
    dataTable = $('#producttable').DataTable({
        "language": {
            "url": "https://cdn.datatables.net/plug-ins/1.13.6/i18n/nl-NL.json?v=" + new Date().getTime()
        },
        'ajax': {
        ...
        'columns': [
            ...
            { 'data': 'categoryName', 'width': '20%' },
            {
                ...
                <a onclick="Delete('/Admin/Product/Delete/'+${data})" class="btn btn-danger w-25"><i class="bi bi-trash-fill mx-2"></i> Wis</a>
                </div>
                `
                }
            }
